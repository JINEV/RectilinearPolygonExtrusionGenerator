    ...
    for j in range(num_columns):
        if gadget_names_grid[i][j] is not None:
            if gadget_names_grid[i][j].startswith("two_extruded_linear") and not current_one:
                ...
                current_one = False
            elif (gadget_names_grid[i][j].startswith("one_extruded") or gadget_names_grid[i][j].startswith("two_extruded_ortho")) and current_linear:
                current_one = True
                ...
                current_linear = False
                current_linear_index = [None, None]
            elif (gadget_names_grid[i][j].startswith("one_extruded") or gadget_names_grid[i][j].startswith("two_extruded_ortho")) and not current_linear:
                current_one = True
                current_one_index = [i,j]
            else:
                current_one = False
